...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "TERMINAL_ENV", "TERMINAL_SHELL", "TERMINAL_SSH_KEY", "TERMINAL_SSH_PORT",
...
OPTIONAL_ENV_VARS = {
    ...
    # ── Tool API keys ──
    "SEARXNG_URL": {
        "description": "SearxNG URL for local-first privacy-respecting web search (e.g. http://localhost:8080)",
        "prompt": "SearxNG server URL",
    ...
    "BROWSER_CDP_URL": {
        "description": "Chrome DevTools Protocol URL for attaching to an existing browser (e.g. http://localhost:9222)",
        "prompt": "Browser CDP URL",
