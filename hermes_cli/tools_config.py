...
CONFIGURABLE_TOOLSETS = [
    ...
    ("image_gen",       "🎨 Image Generation",          "image_generate via FAL.ai"),
    ("moa",             "🧠 Mixture-of-Agents",         "mixture_of_agents via OpenRouter"),
...
TOOL_CATEGORIES = {
    ...
    "web": {
        ...
        "setup_note": "Using local SearxNG backend for search and extraction.",
        "icon": "🔍",
        "providers": [
            {
                "name": "SearxNG (Local)",
                "badge": "★ recommended · free",
                "tag": "Self-hosted privacy-respecting search engine",
                "web_backend": "searxng",
                "env_vars": [
                    {"key": "SEARXNG_URL", "prompt": "SearxNG instance URL", "default": "http://localhost:8080"},
                ],
            },
        ],
    },
        ...
        "providers": [
            {
                ...
                "badge": "★ recommended · free",
                "tag": "Connect to your actual browser via CDP",
                "env_vars": [
                    {"key": "BROWSER_CDP_URL", "prompt": "Browser CDP URL (optional, auto-detected if blank)", "default": ""},
                ],
                "browser_provider": "browser-harness",
                "post_setup": "agent_browser",
            },
            {
                "name": "Local Headless",
                "badge": "free",
                "tag": "Headless Chromium via agent-browser",
                "env_vars": [],
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in ("agent_browser", "browserbase"):
        ...
        if not node_modules.exists() and npm_path:
        ...
        if not camofox_dir.exists() and npm_path:
